...
// JG 6 May use multicatch
    ...
    private void initComponents() {
        ...
        jLabel13.setText(AppLocal.getIntString("label.discount"));
        jLabel13.setMaximumSize(new java.awt.Dimension(140, 25));
        jLabel13.setMinimumSize(new java.awt.Dimension(140, 25));
